...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 18 2015 г., 06:56
...
(28, '2014-12-16', 6, 27, 'hj76867hg', 'ghjhgj', '', 18, 'Usd', 1),
...
(40, '2014-12-17', 6, 27, 'vcv', 'cvv', '', 20, 'Usd', 3),
...
INSERT INTO `users` (`Id`, `Login`, `Password`, `Reg_Date`, `Role`, `Comments`, `Requisites`, `Jabber`, `Wmid`) VALUES
...
(39, 'qwewq', '$2a$13$Jr1sSwN5pjgBpKdD3ww6EeX.B8NhTi2b1/FlgMbM0/L6CubCtZq/e', '2015-02-17 19:42:35', 1, 'eeee', 'aaa', 'zzzz', 'xxxx'),
(40, 'zzz', '$2a$13$tawDwQfe.RJsk3PMUpbzv.TvOnYU52u.4bGkLQOYeB5rUHGhnC62S', '2015-02-17 19:42:55', 1, '', 'sada', '', '');
