...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'OnlyFor',array('class' => 'col-lg-2 control-label','label'=>Yii::t('main-ui','Only For'))); ?>
		<div class="col-lg-10">
			<?php
			$list = array(2 => 'Support', 3 => 'Staffer');
			echo CHtml::dropDownList('News[OnlyFor]', $model['OnlyFor'], $list, array('class'=>'form-control'));
